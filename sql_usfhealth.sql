...
(
		is_id					int not null,	/*identifier number for tb_individuals_samples*/
		is_date_collected		date,			/*date of the collection for the sample*/
		is_time_collected		time,			/*time of the collection for the sample*/
...
(
		poo_id					int not null,	/*identifier number for tb_pools*/
		poo_date_registered		date,			/*date of the registration for the pool*/
		poo_time_registered		time,			/*time of the registration for the pool*/
...
(
		pr_id					int not null,	/*identifier number for tb_pools_results*/
...
(
		st_id					int not null,	/*identifier number for tb_samples_types*/
...
(
		ss_id					int not null,	/*identifier number for tb_samples_status*/
...
(
		rs_id					int not null,	/*identifier number for tb_results_status*/
...
(
		indcat_id				int not null,	/*identifier number for tb_individuals_category*/
...
(
		unt_id				int not null,		/*identifier number for tb_units*/
...
(
		loc_id				int not null,		/*identifier number for tb_locations*/
...
(
		sfc_id				int not null,		/*identifier number for tb_surfaces*/
...
(
		us_id					int not null,	/*identifier number for tb_locations_samples*/
		us_date_collected		date,			/*date of the collection for the sample*/
		us_time_collected		time,			/*time of the collection for the sample*/
...
(
		usres_id				int not null,	/*identifier number for tb_units_samples_results*/
		us_id					int,			/*foreign key for tb_units_samples (units samples id to which these results belong) */
		usres_date_result		date,			/*date of the registration for the units samples results*/
		usres_time_result		time,			/*time of the registration for the units samples results*/
...
(
		tst_id					int not null,	/*identifier number for tb_tests*/
...
(
		ussfc_id				int not null,	/*identifier number for tb_units_samples_surfaces*/
...
(
		usr_id				int not null,		/*identifier number for tb_users*/
